    ...
    overlays: [
      {
        id: "img-title",
        type: "text" as const,
        text: "<h2 style='font-size:2rem;font-weight:600;margin-bottom:0.3rem'>圖片覆蓋層</h2><p style='font-size:0.95rem;opacity:0.6'>支援 URL 貼入或本地上傳，可拖曳定位、調整大小</p>",
        position: "top",
        animation: "fadeIn",
        visible: true,
        style: {
      ...
      },
      {
        ...
        type: "image" as const,
        text: "Aurora",
        imageSrc: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=600&q=80",
        imageWidth: 280,
        imageOpacity: 0.95,
        imageBorderRadius: 16,
        position: "custom",
        customPosition: { x: 70, y: 58 },
        animation: "fadeIn",
        visible: true,
        delay: 500,
      },
    ],
    notes: "展示圖片覆蓋層功能：可以在任何投影片上插入圖片，支援拖曳定位和大小調整。",
  },
  {
    id: "slide-5",
    overlays: [
